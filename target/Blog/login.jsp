...
<title>HewieBlog系统后台登录页面-Powered by Hewie</title>
<script src="${pageContext.request.contextPath}/static/plug/bootstrap/js/jquery-1.11.2.min.js"></script>
<STYLE>
body{
	background: #ebebeb;
...
<form action="${pageContext.request.contextPath}/blogger/login.do" method="post" onsubmit="return checkForm()">
	<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
		...
		<P style="padding: 30px 0px 10px 0px; position: relative;">
			<SPAN class="u_logo" style="margin-left: 25px;"></SPAN>
			<INPUT id="userName" name="userName" class="ipt" type="text" placeholder="请输入用户名" value="${blogger.userName }"> 
	    </P>
		<P style="padding: 0 0px 10px 0px;position: relative;">
			<SPAN class="p_logo" style="margin-left: 25px;"></SPAN>         
		...
		<DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
			...
			<SPAN style="float: left;">HewieBlog博客系统</SPAN> 
