...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px;">
	<form id="fm1" action="${pageContext.request.contextPath}/admin/blogger/save.do" method="post"  enctype="multipart/form-data">
		<table cellspacing="20px;">
			...
			<tr>
				<td width="80px;">地址：</td>
				<td>
					<input type="text" id="address" name="address" style="width: 400px;" placeholder="输入时省份与地级市之间加入横线与空格，更加美观"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="900px;" >
					<script id="profile" type="text/plain" style="width:100%;height:200px;"></script>
			...
			<tr>
				<td></td>
				<td>	
					<a href="javascript:submitData()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">修改信息</a>
				</td>
			</tr>
		</table>
	</form>
