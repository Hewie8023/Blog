	...
	function submitData(){
		...
		if(title==null || title==""){
			...
			$.post("${pageContext.request.contextPath}/admin/diary/save.do",
					{'id':'${param.id}','title':title,'author':author,'contentNoTag':UE.getEditor('editor').getContentTxt(),'content':content,
...
<div id="p" class="easyui-panel" title="修改日记" style="padding: 10px;">
...
<script type="text/javascript">
    ...
    ue.addListener("ready",function(){
    	//通过ajax请求数据
    	UE.ajax.request("${pageContext.request.contextPath}/admin/diary/findById.do",
    			{
    				method:"post",
    				async:false,
    				data:{"id":"${param.id}"},
