                    ...
                    <div class="blog-module shadow">
                        ...
                        <ul class="fa-ul blog-module-ul">
                        	<c:forEach var="hotBlog" items="${hotBlogList }" >
                            	<li><i class="fa-li fa fa-hand-o-right"></i><a onfocus="this.blur();" href="${pageContext.request.contextPath}/blog/articles/${hotBlog.blogId}.html" data-toggle="tooltip" data-placement="top" title="${hotBlog.title }">${hotBlog.title }</a></li>
                       		</c:forEach>
                        </ul>
                    </div>
                    <div class="blog-module shadow">
                        ...
                        <ul class="fa-ul blog-module-ul">
                        	<c:forEach var="randBlog" items="${randBlogList }">
                        		<li><i class="fa-li fa fa-hand-o-right"></i><a onfocus="this.blur();" href="${pageContext.request.contextPath}/blog/articles/${randBlog.blogId}.html" data-toggle="tooltip" data-placement="top" title="${randBlog.title }">${randBlog.title }</a></li>
                        	</c:forEach>
                        </ul>
                    </div>
                    <!--右边悬浮 平板或手机设备显示-->
