...
<script type="text/javascript">
	...
	function deleteLink(){
		...
		var ids=strIds.join(",");
		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>个友情链接吗？",function(r){
			if(r){
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			...
			<tr>
				<td>友情链接排序号：</td>
				<td>
					<input type="text" id="orderNo" name="orderNo" class="easyui-numberbox" required="true" style="width: 60px;"/>&nbsp;(友情链接按照排序序号从小到大排序)
				</td>
			</tr>
		</table>
	</form>
