...
public class NavUtil {
	...
	public static String getBlogListNavigation(String typeName,String id){
		...
		navCode.append("<blockquote class=' shadow'><a  href='/index.html' data-toggle='tooltip' data-placement='bottom' title='网站首页'>网站首页</a>");
	...
	public static String getBlogArticleNavigation(String typeName,String id,String title){
		StringBuffer navCode = new StringBuffer();
		navCode.append("<blockquote class=' shadow'><a  href='/index.html' data-toggle='tooltip' data-placement='bottom' title='网站首页'>网站首页</a>");
		navCode.append("<a><cite>&nbsp;>&nbsp;</cite></a><a href='/blog/list.html?typeId="+id+"' data-toggle='tooltip' data-placement='bottom' title='"+typeName+"'>"+typeName+"</a>");
	...
	public static String getDiaryArticleNavigation(String title){
		...
		navCode.append("<a><cite>&nbsp;>&nbsp;</cite></a><a href='/diary/list.html' data-toggle='tooltip' data-placement='bottom' title='日记'>日记</a>");
		navCode.append("<a><cite>&nbsp;>&nbsp;"+title+"</cite></a></blockquote>");
		return navCode.toString();
	}
}
